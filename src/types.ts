...
export interface UserProfile {
  ...
  activeMode?: 'CLIENT' | 'PROFESSIONAL'; hasClientProfile?: boolean; hasProfessionalProfile?: boolean; workHours?: string; isProfessional?: boolean;
  businessName?: string; professionId?: string; professionName?: string; specialties?: string[]; description?: string; workZoneRadiusKm?: number;
