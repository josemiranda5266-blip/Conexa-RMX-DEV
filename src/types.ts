...
export interface ServiceRequest { id: string; clientId: string; clientName: string; clientAvatar: string; title: string; category: string; professionName: string; description: string; images?: string[]; approxLocation: string; preferredDate: string; preferredTimeSlot: string; estimatedBudgetArs?: number; urgency: 'NORMAL' | 'ALTA' | 'URGENTE'; status: JobStatus; createdAt: string; quotesCount: number; assignedProfessionalId?: string; biddingProfessionalIds?: string[]; discoveryMode?: 'OPEN' | 'TARGETED'; isDemoData?: boolean; radarOpportunityId?: string; sourceType?: 'DIRECT' | 'RADAR'; }
